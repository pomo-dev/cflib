...
project = 'PoMo'
copyright = '2015, Dominik Schrempf'
...
latex_documents = [
  ('index', 'cflib.tex', 'Counts File Library Documentation',
   'Dominik Schrempf', 'manual'),
]
...
man_pages = [
    ('index', 'cflib', 'Counts File Library Documentation',
     ['Dominik Schrempf'], 1)
]
...
texinfo_documents = [
  ('index', 'cflib', 'Counts File Library Documentation',
   'Dominik Schrempf', 'cflib',
   'Scripts for conversion to Counts File format used by PoMo.',
   'Miscellaneous'),
]
